    ...
    <div className="home-page">
      ...
      >
        <div className="container">
          <div className="row">
            <div
              className="col-sm-6 d-flex d-sm-block flex-column
                 align-items-center"
            >
              <h2 className="mb-0 text-black fw-bold">Welcomw To</h2>
              <h1
                className="mb-5 text-black fw-bold text-center 
                    text-sm-start"
              >
                React Restaurant
              </h1>
        ...
        <div className="row">
          ...
          >
            ...
            <p>
              ...
              Voluptates quibusdam necessitatibus error deleniti, vero maxime
              commodi totam eaque quia expedita.
            </p>
            <p className="mb-5">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Repellendus, quia!
      ...
      <div className="menu-section py-5 text-light shadow">
        <div className="container d-flex flex-column align-items-center">
          ...
          <div className="row mb-5 2-100">
            ...
            mb-5 mb-lg-0"
            >
              <h1 className="fs-2 mb-5">Drinks</h1>
              <ul className="px-0">
                <li className="d-flex justify-content-between">
